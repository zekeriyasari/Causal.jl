...
macro def_discrete_system(ex) 
    #= NOTE: 
        ...
        @def_discrete_system mutable struct MyDiscreteSystem{RH, RO, ST, IP, TR} <: AbstractDiscreteSystem
            righthandside::RH
            readout::RO 
            state::ST 
            input::IP 
    ...
    fields = quote
        ...
        integrator::$(IT) = Jusdl.construct_integrator(Jusdl.DiscreteProblem, input, righthandside, state, t,
